...
<li>exit - Выход из программы. Вся торговля останавливается. На данном этапе при следующем запуске программа не будет помнить торги с предыдущей сессии
  ...
  При вводе команд {figi} означает, что рядом с командой через пробел надо ввести figi интересующего вас инструмента.
  Рекомендуем начинать работу с фонда TMOS от Тинькофф. Торговля бумагами этого фонда осуществляется без комиссии, а лот стоит около 4 рублей. FIGI фонда BBG333333333
